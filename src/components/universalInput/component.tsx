import { type HTMLInputTypeAttribute, type InputEvent, useEffect } from "react";

import { PokeGuessOptions } from "@/types/pokemon.type";
...
export default function UniversalInput({
    ...
    function handleOnInput(event: InputEvent<HTMLInputElement>) {
    ...
    function handleBeforeInput(event: InputEvent<HTMLInputElement>) {
        if (!event.data) {
